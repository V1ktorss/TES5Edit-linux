...
const
  wbConditionFunctions : array[0..451] of TConditionFunction = (
    (Index:   1; Name: 'GetDistance'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 5; Name: 'GetLocked'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:   6; Name: 'GetPos'; ParamType1: ptAxis; ParamType2: ptNone),
    (Index:   8; Name: 'GetAngle'; ParamType1: ptAxis; ParamType2: ptNone),
    (Index:  10; Name: 'GetStartingPos'; ParamType1: ptAxis; ParamType2: ptNone),
    (Index:  11; Name: 'GetStartingAngle'; ParamType1: ptAxis; ParamType2: ptNone),
    (Index: 12; Name: 'GetSecondsPassed'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  14; Name: 'GetActorValue'; ParamType1: ptActorValue; ParamType2: ptNone),
    (Index: 18; Name: 'GetCurrentTime'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 24; Name: 'GetScale'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 25; Name: 'IsMoving'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 26; Name: 'IsTurning'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  27; Name: 'GetLineOfSight'; ParamType1: ptReference; ParamType2: ptNone),
    (Index:  32; Name: 'GetInSameCell'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 35; Name: 'GetDisabled'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  36; Name: 'MenuMode'; ParamType1: ptMenuMode; ParamType2: ptNone),
    (Index: 39; Name: 'GetDisease'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 40; Name: 'GetVampire'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 41; Name: 'GetClothingValue'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  42; Name: 'SameFaction'; ParamType1: ptActor; ParamType2: ptNone),
    (Index:  43; Name: 'SameRace'; ParamType1: ptActor; ParamType2: ptNone),
    (Index:  44; Name: 'SameSex'; ParamType1: ptActor; ParamType2: ptNone),
    (Index:  45; Name: 'GetDetected'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 46; Name: 'GetDead'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  47; Name: 'GetItemCount'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 48; Name: 'GetGold'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 49; Name: 'GetSleeping'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 50; Name: 'GetTalkedToPC'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  53; Name: 'GetScriptVariable'; ParamType1: ptReference; ParamType2: ptVariableName),
    (Index:  56; Name: 'GetQuestRunning'; ParamType1: ptQuest; ParamType2: ptNone),
    (Index:  58; Name: 'GetStage'; ParamType1: ptQuest; ParamType2: ptNone),
    ...
    (Index: 61; Name: 'GetAlarmed'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 62; Name: 'IsRaining'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 63; Name: 'GetAttacked'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 64; Name: 'GetIsCreature'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 65; Name: 'GetLockLevel'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  66; Name: 'GetShouldAttack'; ParamType1: ptActor; ParamType2: ptNone),
    (Index:  67; Name: 'GetInCell'; ParamType1: ptCell; ParamType2: ptNone),
    (Index:  68; Name: 'GetIsClass'; ParamType1: ptClass; ParamType2: ptNone),
    (Index:  69; Name: 'GetIsRace'; ParamType1: ptRace; ParamType2: ptNone),
    (Index:  70; Name: 'GetIsSex'; ParamType1: ptSex; ParamType2: ptNone),
    (Index:  71; Name: 'GetInFaction'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index:  72; Name: 'GetIsID'; ParamType1: ptBaseObject; ParamType2: ptNone),
    (Index:  73; Name: 'GetFactionRank'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index:  74; Name: 'GetGlobalValue'; ParamType1: ptGlobal; ParamType2: ptNone),
    (Index: 75; Name: 'IsSnowing'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  76; Name: 'GetDisposition'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 77; Name: 'GetRandomPercent'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  79; Name: 'GetQuestVariable'; ParamType1: ptQuest; ParamType2: ptVariableName),
    (Index: 80; Name: 'GetLevel'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 81; Name: 'GetArmorRating'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  84; Name: 'GetDeadCount'; ParamType1: ptActorBase; ParamType2: ptNone),
    (Index: 91; Name: 'GetIsAlerted'; ParamType1: ptNone; ParamType2: ptNone),
    (Index:  98; Name: 'GetPlayerControlsDisabled'; ParamType1: ptInteger; ParamType2: ptInteger),
    (Index:  99; Name: 'GetHeadingAngle'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 101; Name: 'IsWeaponOut'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 102; Name: 'IsTorchOut'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 103; Name: 'IsShieldOut'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 106; Name: 'IsFacingUp'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 107; Name: 'GetKnockedState'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 108; Name: 'GetWeaponAnimType'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 109; Name: 'IsWeaponSkillType'; ParamType1: ptActorValue; ParamType2: ptNone),
    (Index: 110; Name: 'GetCurrentAIPackage'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 111; Name: 'IsWaiting'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 112; Name: 'IsIdlePlaying'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 116; Name: 'GetMinorCrimeCount'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 117; Name: 'GetMajorCrimeCount'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 118; Name: 'GetActorAggroRadiusViolated'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 122; Name: 'GetCrime'; ParamType1: ptActor; ParamType2: ptCrimeType),
    (Index: 123; Name: 'IsGreetingPlayer'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 125; Name: 'IsGuard'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 127; Name: 'HasBeenEaten'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 128; Name: 'GetFatiguePercentage'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 129; Name: 'GetPCIsClass'; ParamType1: ptClass; ParamType2: ptNone),
    (Index: 130; Name: 'GetPCIsRace'; ParamType1: ptRace; ParamType2: ptNone),
    (Index: 131; Name: 'GetPCIsSex'; ParamType1: ptSex; ParamType2: ptNone),
    (Index: 132; Name: 'GetPCInFaction'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index: 133; Name: 'SameFactionAsPC'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 134; Name: 'SameRaceAsPC'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 135; Name: 'SameSexAsPC'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 136; Name: 'GetIsReference'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 141; Name: 'IsTalking'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 142; Name: 'GetWalkSpeed'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 143; Name: 'GetCurrentAIProcedure'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 144; Name: 'GetTrespassWarningLevel'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 145; Name: 'IsTrespassing'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 146; Name: 'IsInMyOwnedCell'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 147; Name: 'GetWindSpeed'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 148; Name: 'GetCurrentWeatherPercent'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 149; Name: 'GetIsCurrentWeather'; ParamType1: ptWeather; ParamType2: ptNone),
    (Index: 150; Name: 'IsContinuingPackagePCNear'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 153; Name: 'CanHaveFlames'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 154; Name: 'HasFlames'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 157; Name: 'GetOpenState'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 159; Name: 'GetSitting'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 160; Name: 'GetFurnitureMarkerID'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 161; Name: 'GetIsCurrentPackage'; ParamType1: ptPackage; ParamType2: ptNone),
    (Index: 162; Name: 'IsCurrentFurnitureRef'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 163; Name: 'IsCurrentFurnitureObj'; ParamType1: ptFurniture; ParamType2: ptNone),
    (Index: 170; Name: 'GetDayOfWeek'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 172; Name: 'GetTalkedToPCParam'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 175; Name: 'IsPCSleeping'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 176; Name: 'IsPCAMurderer'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 180; Name: 'GetDetectionLevel'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 182; Name: 'GetEquipped'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 185; Name: 'IsSwimming'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 190; Name: 'GetAmountSoldStolen'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 192; Name: 'GetIgnoreCrime'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 193; Name: 'GetPCExpelled'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index: 195; Name: 'GetPCFactionMurder'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index: 197; Name: 'GetPCEnemyofFaction'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index: 199; Name: 'GetPCFactionAttack'; ParamType1: ptFaction; ParamType2: ptNone),
    (Index: 203; Name: 'GetDestroyed'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 214; Name: 'HasMagicEffect'; ParamType1: ptBaseEffect; ParamType2: ptNone),
    (Index: 215; Name: 'GetDefaultOpen'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 219; Name: 'GetAnimAction'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 223; Name: 'IsSpellTarget'; ParamType1: ptEffectItem; ParamType2: ptNone),
    (Index: 224; Name: 'GetVATSMode'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 225; Name: 'GetPersuasionNumber'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 226; Name: 'GetSandman'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 227; Name: 'GetCannibal'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 228; Name: 'GetIsClassDefault'; ParamType1: ptClass; ParamType2: ptNone),
    (Index: 229; Name: 'GetClassDefaultMatch'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 230; Name: 'GetInCellParam'; ParamType1: ptCell; ParamType2: ptReference),
    (Index: 235; Name: 'GetVatsTargetHeight'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 237; Name: 'GetIsGhost'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 242; Name: 'GetUnconscious'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 244; Name: 'GetRestrained'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 246; Name: 'GetIsUsedItem'; ParamType1: ptBaseObject; ParamType2: ptNone),
    (Index: 247; Name: 'GetIsUsedItemType'; ParamType1: ptFormType; ParamType2: ptNone),
    (Index: 254; Name: 'GetIsPlayableRace'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 255; Name: 'GetOffersServicesNow'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 258; Name: 'GetUsedItemLevel'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 259; Name: 'GetUsedItemActivate'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 264; Name: 'GetBarterGold'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 265; Name: 'IsTimePassing'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 266; Name: 'IsPleasant'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 267; Name: 'IsCloudy'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 274; Name: 'GetArmorRatingUpperBody'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 277; Name: 'GetBaseActorValue'; ParamType1: ptActorValue; ParamType2: ptNone),
    (Index: 278; Name: 'IsOwner'; ParamType1: ptOwner; ParamType2: ptNone),
    (Index: 280; Name: 'IsCellOwner'; ParamType1: ptCell; ParamType2: ptOwner),
    (Index: 282; Name: 'IsHorseStolen'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 285; Name: 'IsLeftUp'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 286; Name: 'IsSneaking'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 287; Name: 'IsRunning'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 288; Name: 'GetFriendHit'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 289; Name: 'IsInCombat'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 300; Name: 'IsInInterior'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 304; Name: 'IsWaterObject'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 306; Name: 'IsActorUsingATorch'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 309; Name: 'IsXBox'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 310; Name: 'GetInWorldspace'; ParamType1: ptWorldSpace; ParamType2: ptNone),
    (Index: 312; Name: 'GetPCMiscStat'; ParamType1: ptMiscStat; ParamType2: ptNone),
    (Index: 313; Name: 'IsActorEvil'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 314; Name: 'IsActorAVictim'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 315; Name: 'GetTotalPersuasionNumber'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 318; Name: 'GetIdleDoneOnce'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 320; Name: 'GetNoRumors'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 323; Name: 'WhichServiceMenu'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 327; Name: 'IsRidingHorse'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 332; Name: 'IsInDangerousWater'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 338; Name: 'GetIgnoreFriendlyHits'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 339; Name: 'IsPlayersLastRiddenHorse'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 353; Name: 'IsActor'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 354; Name: 'IsEssential'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 358; Name: 'IsPlayerMovingIntoNewSpace'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 361; Name: 'GetTimeDead'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 362; Name: 'GetPlayerHasLastRiddenHorse'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 365; Name: 'IsChild'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 367; Name: 'GetLastPlayerAction'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 368; Name: 'IsPlayerActionActive'; ParamType1: ptPlayerAction; ParamType2: ptNone),
    (Index: 370; Name: 'IsTalkingActivatorActor'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 372; Name: 'IsInList'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 382; Name: 'GetHasNote'; ParamType1: ptNote; ParamType2: ptNone),
    (Index: 391; Name: 'GetHitLocation'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 392; Name: 'IsPC1stPerson'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 397; Name: 'GetCauseofDeath'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 398; Name: 'IsLimbGone'; ParamType1: ptBodyLocation; ParamType2: ptNone),
    (Index: 399; Name: 'IsWeaponInList'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 403; Name: 'HasFriendDisposition'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 408; Name: 'GetVATSValue'; ParamType1: ptVATSValueFunction; ParamType2: ptVATSValueParam),
    (Index: 409; Name: 'IsKiller'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 410; Name: 'IsKillerObject'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 411; Name: 'GetFactionCombatReaction'; ParamType1: ptFaction; ParamType2: ptFaction),
    (Index: 415; Name: 'Exists'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 416; Name: 'GetGroupMemberCount'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 417; Name: 'GetGroupTargetCount'; ParamType1: ptNone; ParamType2: ptNone),
    ...
    (Index: 427; Name: 'GetIsVoiceType'; ParamType1: ptVoiceType; ParamType2: ptNone),
    (Index: 428; Name: 'GetPlantedExplosive'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 430; Name: 'IsActorTalkingThroughActivator'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 431; Name: 'GetHealthPercentage'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 433; Name: 'GetIsObjectType'; ParamType1: ptFormType; ParamType2: ptNone),
    (Index: 435; Name: 'GetDialogueEmotion'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 436; Name: 'GetDialogueEmotionValue'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 438; Name: 'GetIsCreatureType'; ParamType1: ptCreatureType; ParamType2: ptNone),
    (Index: 446; Name: 'GetInZone'; ParamType1: ptEncounterZone; ParamType2: ptNone),
    (Index: 449; Name: 'HasPerk'; ParamType1: ptPerk; ParamType2: ptInteger),
    (Index: 450; Name: 'GetFactionRelation'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 451; Name: 'IsLastIdlePlayed'; ParamType1: ptIdleForm; ParamType2: ptNone),
    (Index: 454; Name: 'GetPlayerTeammate'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 455; Name: 'GetPlayerTeammateCount'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 459; Name: 'GetActorCrimePlayerEnemy'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 460; Name: 'GetActorFactionPlayerEnemy'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 462; Name: 'IsPlayerTagSkill'; ParamType1: ptActorValue; ParamType2: ptNone),
    (Index: 464; Name: 'IsPlayerGrabbedRef'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 471; Name: 'GetDestructionStage'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 474; Name: 'GetIsAlignment'; ParamType1: ptAlignment; ParamType2: ptNone),
    (Index: 478; Name: 'GetThreatRatio'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 480; Name: 'GetIsUsedItemEquipType'; ParamType1: ptEquipType; ParamType2: ptNone),
    (Index: 489; Name: 'GetConcussed'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 492; Name: 'GetMapMarkerVisible'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 495; Name: 'GetPermanentActorValue'; ParamType1: ptActorValue; ParamType2: ptNone),
    (Index: 496; Name: 'GetKillingBlowLimb'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 500; Name: 'GetWeaponHealthPerc'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 503; Name: 'GetRadiationLevel'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 510; Name: 'GetLastHitCritical'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 515; Name: 'IsCombatTarget'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 518; Name: 'GetVATSRightAreaFree'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 519; Name: 'GetVATSLeftAreaFree'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 520; Name: 'GetVATSBackAreaFree'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 521; Name: 'GetVATSFrontAreaFree'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 522; Name: 'GetIsLockBroken'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 523; Name: 'IsPS3'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 524; Name: 'IsWin32'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 525; Name: 'GetVATSRightTargetVisible'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 526; Name: 'GetVATSLeftTargetVisible'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 527; Name: 'GetVATSBackTargetVisible'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 528; Name: 'GetVATSFrontTargetVisible'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 531; Name: 'IsInCriticalStage'; ParamType1: ptCriticalStage; ParamType2: ptNone),
    (Index: 533; Name: 'GetXPForNextLevel'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 546; Name: 'GetQuestCompleted'; ParamType1: ptQuest; ParamType2: ptNone),
    (Index: 550; Name: 'IsGoreDisabled'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 555; Name: 'GetSpellUsageNum'; ParamType1: ptEffectItem; ParamType2: ptNone),
    (Index: 557; Name: 'GetActorsInHigh'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 558; Name: 'HasLoaded3D'; ParamType1: ptNone; ParamType2: ptNone),
    ...
    (Index: 586; Name: 'IsHardcore'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 601; Name: 'GetForceHitReaction'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 607; Name: 'ChallengeLocked'; ParamType1: ptChallenge; ParamType2: ptNone),
    (Index: 610; Name: 'GetCasinoWinningStage'; ParamType1: ptCasino; ParamType2: ptNone),
    (Index: 612; Name: 'PlayerInRegion'; ParamType1: ptRegion; ParamType2: ptNone),
    (Index: 614; Name: 'GetChallengeCompleted'; ParamType1: ptChallenge; ParamType2: ptNone),
    (Index: 619; Name: 'IsAlwaysHardcore'; ParamType1: ptNone; ParamType2: ptNone),

    // Added by (x)NVSE - up to v6.3.4
    (Index: 1024; Name: 'GetNVSEVersion'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1025; Name: 'GetNVSERevision'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1026; Name: 'GetNVSEBeta'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1028; Name: 'GetWeight'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1029; Name: 'GetHealth'; ParamType1: ptFormType; ParamType2: ptNone),
    (Index: 1030; Name: 'GetValue'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1034; Name: 'GetType'; ParamType1: ptFormType; ParamType2: ptNone),
    (Index: 1036; Name: 'GetEquipType'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1038; Name: 'GetWeaponClipRounds'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1039; Name: 'GetAttackDamage'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1040; Name: 'GetWeaponType'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1041; Name: 'GetWeaponMinSpread'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1042; Name: 'GetWeaponSpread'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1044; Name: 'GetWeaponSightFOV'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1045; Name: 'GetWeaponMinRange'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1046; Name: 'GetWeaponMaxRange'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1047; Name: 'GetWeaponAmmoUse'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1048; Name: 'GetWeaponActionPoints'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1049; Name: 'GetWeaponCritDamage'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1050; Name: 'GetWeaponCritChance'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1052; Name: 'GetWeaponFireRate'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1053; Name: 'GetWeaponAnimAttackMult'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1054; Name: 'GetWeaponRumbleLeftMotor'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1055; Name: 'GetWeaponRumbleRightMotor'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1056; Name: 'GetWeaponRumbleDuration'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1057; Name: 'GetWeaponRumbleWavelength'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1058; Name: 'GetWeaponAnimShotsPerSec'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1059; Name: 'GetWeaponAnimReloadTime'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1060; Name: 'GetWeaponAnimJamTime'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1061; Name: 'GetWeaponSkill'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1062; Name: 'GetWeaponResistType'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1063; Name: 'GetWeaponFireDelayMin'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1064; Name: 'GetWeaponFireDelayMax'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1065; Name: 'GetWeaponAnimMult'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1066; Name: 'GetWeaponReach'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1067; Name: 'GetWeaponIsAutomatic'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1068; Name: 'GetWeaponHandGrip'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1069; Name: 'GetWeaponReloadAnim'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1070; Name: 'GetWeaponBaseVATSChance'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1071; Name: 'GetWeaponAttackAnimation'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1072; Name: 'GetWeaponNumProjectiles'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1073; Name: 'GetWeaponAimArc'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1074; Name: 'GetWeaponLimbDamageMult'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1075; Name: 'GetWeaponSightUsage'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1076; Name: 'GetWeaponHasScope'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1089; Name: 'ListGetFormIndex'; ParamType1: ptFormList; ParamType2: ptFormType),
    (Index: 1098; Name: 'GetEquippedCurrentHealth'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 1102; Name: 'GetNumItems'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1105; Name: 'GetCurrentHealth'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1107; Name: 'IsKeyPressed'; ParamType1: ptInteger; ParamType2: ptInteger),
    (Index: 1131; Name: 'IsControlPressed'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 1144; Name: 'GetArmorAR'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1145; Name: 'IsPowerArmor'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1148; Name: 'IsQuestItem'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1203; Name: 'GetArmorDT'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1212; Name: 'GetWeaponRequiredStrength'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1213; Name: 'GetWeaponRequiredSkill'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1218; Name: 'GetAmmoSpeed'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1219; Name: 'GetAmmoConsumedPercent'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1254; Name: 'GetWeaponLongBursts'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1256; Name: 'GetWeaponFlags1'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1257; Name: 'GetWeaponFlags2'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1266; Name: 'GetEquippedWeaponModFlags'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1271; Name: 'HasOwnership'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 1272; Name: 'IsOwned'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 1274; Name: 'GetDialogueTarget'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 1275; Name: 'GetDialogueSubject'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 1276; Name: 'GetDialogueSpeaker'; ParamType1: ptActor; ParamType2: ptNone),
    (Index: 1278; Name: 'GetAgeClass'; ParamType1: ptActorBase; ParamType2: ptNone),
    (Index: 1286; Name: 'GetTokenValue'; ParamType1: ptFormType; ParamType2: ptNone),
    (Index: 1288; Name: 'GetTokenRef'; ParamType1: ptFormType; ParamType2: ptNone),
    (Index: 1291; Name: 'GetPaired'; ParamType1: ptInventoryObject; ParamType2: ptActorBase),
    (Index: 1292; Name: 'GetRespawn'; ParamType1: ptACtorBase; ParamType2: ptNone),
    (Index: 1294; Name: 'GetPermanent'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 1297; Name: 'IsRefInList'; ParamType1: ptFormList; ParamType2: ptFormType),
    (Index: 1301; Name: 'GetPackageCount'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 1440; Name: 'IsPlayerSwimming'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1441; Name: 'GetTFC'; ParamType1: ptNone; ParamType2: ptNone),
    ...
    (Index: 1541; Name: 'GetActorFIKstatus'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1587; Name: 'GetWeaponRegenRate'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1590; Name: 'CallFunctionCond'; ParamType1: ptFormList; ParamType2: ptInteger),
    (Index: 1623; Name: 'HasAmmoEquipped'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1624; Name: 'GetEquippedWeaponCanUseAmmo'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1625; Name: 'IsEquippedAmmoInList'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 1626; Name: 'GetEquippedWeaponUsesAmmoList'; ParamType1: ptFormList; ParamType2: ptNone),
    ...
    (Index: 4352; Name: 'GetExtendedActorVariable'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 4353; Name: 'GetBaseExtendedActorVariable'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 4355; Name: 'GetModExtendedActorVariable'; ParamType1: ptInventoryObject; ParamType2: ptNone),

    // Added by nvse_extender - up to v19
    (Index: 4420; Name: 'NX_GetEVFl'; ParamType1: ptNone; ParamType2: ptNone),  // Actually ptString, but it cannot be used in GECK
    (Index: 4426; Name: 'NX_GetQVEVFl'; ParamType1: ptQuest; ParamType2: ptInteger),

    // Added by lutana_nvse - now in JIP NVSE Plugin
    (Index: 4612; Name: 'IsButtonPressed'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 4613; Name: 'GetLeftStickX'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4614; Name: 'GetLeftStickY'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4615; Name: 'GetRightStickX'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4616; Name: 'GetRightStickY'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4617; Name: 'GetLeftTrigger'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4618; Name: 'GetRightTrigger'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4708; Name: 'GetArmorClass'; ParamType1: ptForm; ParamType2: ptNone),
    (Index: 4709; Name: 'IsRaceInList'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 4758; Name: 'IsButtonDisabled'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 4761; Name: 'IsButtonHeld'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 4774; Name: 'IsTriggerDisabled'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 4777; Name: 'IsTriggerHeld'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 4822; Name: 'GetReferenceFlag'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 4832; Name: 'GetDistance2D'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 4833; Name: 'GetDistance3D'; ParamType1: ptReference; ParamType2: ptNone),
    (Index: 4843; Name: 'PlayerHasKey'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 4897; Name: 'ActorHasEffect'; ParamType1: ptBaseEffect; ParamType2: ptNone),

    // Added by JIP NVSE Plugin - up to v57.30
    (Index: 5637; Name: 'GetIsPoisoned'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5708; Name: 'IsEquippedWeaponSilenced'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5709; Name: 'IsEquippedWeaponScoped'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5884; Name: 'IsPCInCombat'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5894; Name: 'GetEncumbranceRate'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5947; Name: 'GetActorLightAmount'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5951; Name: 'GetGameDifficulty'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5962; Name: 'GetPCDetectionState'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5969; Name: 'GetPipboyRadio'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5993; Name: 'IsAttacking'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 5994; Name: 'GetPCUsingScope'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6010; Name: 'GetPCUsingIronSights'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6012; Name: 'GetRadiationLevelAlt'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6013; Name: 'IsInWater'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6058; Name: 'GetAlwaysRun'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6059; Name: 'GetAutoMove'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6061; Name: 'GetIsRagdolled'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6065; Name: 'AuxVarGetFltCond'; ParamType1: ptQuest; ParamType2: ptInteger),
    (Index: 6069; Name: 'IsInAir'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6073; Name: 'GetHasContactType'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 6124; Name: 'IsSpellTargetAlt'; ParamType1: ptEffectItem; ParamType2: ptNone),
    (Index: 6167; Name: 'IsIdlePlayingEx'; ParamType1: ptForm; ParamType2: ptNone),
    (Index: 6186; Name: 'IsInCharGen'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6192; Name: 'GetWaterImmersionPerc'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6204; Name: 'IsFleeing'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6217; Name: 'GetTargetUnreachable'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6268; Name: 'IsInKillCam'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6301; Name: 'IsStickDisabled'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 6317; Name: 'GetHardcoreTracking'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6321; Name: 'GetNoteRead'; ParamType1: ptNote; ParamType2: ptNone),
    (Index: 6361; Name: 'GetInFactionList'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 6368; Name: 'GetGroundMaterial'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 6391; Name: 'EquippedWeaponHasModType'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 6426; Name: 'IsSpellTargetList'; ParamType1: ptFormList; ParamType2: ptNone),
    (Index: 6462; Name: 'HasKeywordCond'; ParamType1: ptInteger; ParamType2: ptNone),

    // Added by JohnnyGuitar NVSE - up to v5.07
    (Index: 8501; Name: 'GetBaseScale'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 8549; Name: 'GetQuestFailed'; ParamType1: ptQuest; ParamType2: ptNone),
    (Index: 8623; Name: 'GetLocationSpecificLoadScreensOnly'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 8684; Name: 'GetPlayerCamFOV'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 8692; Name: 'AudioMarkerGetController'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 8701; Name: 'AudioMarkerGetCurrent'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 8706; Name: 'GameGetSecondsPassed'; ParamType1: ptNone; ParamType2: ptNone),

    // Added by AnhNVSE - up to v1.3.1
    (Index: 9732; Name: 'GetQuestCompletedAlt'; ParamType1: ptQuest; ParamType2: ptNone),
    (Index: 9753; Name: 'GetArmorARAlt'; ParamType1: ptArmor; ParamType2: ptNone),

    // Added by TTW nvse plugin
    (Index: 10247; Name: 'TTW_GetEquippedWeaponSkill'; ParamType1: ptNone; ParamType2: ptNone),

    // Added by SUP NVSE - up to v8.55
    (Index: 10648; Name: 'IsPlayerOverencumbered'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 10758; Name: 'SUPGetConditionVarFloat'; ParamType1: ptInteger; ParamType2: ptNone),

    // Added by ShowOff xNVSE Plugin - up to v1.80
    (Index: 11414; Name: 'GetPlayerCanPickpocketEquippedItems'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11415; Name: 'GetPCHasSleepWaitOverride'; ParamType1: ptNone; ParamType2: ptNone),
    ...
    (Index: 11421; Name: 'IsWeaponMelee'; ParamType1: ptWeapon; ParamType2: ptNone),
    (Index: 11422; Name: 'IsEquippedWeaponMelee'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11423; Name: 'IsWeaponRanged'; ParamType1: ptWeapon; ParamType2: ptNone),
    (Index: 11424; Name: 'IsEquippedWeaponRanged'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11425; Name: 'GetChallengeProgress'; ParamType1: ptChallenge; ParamType2: ptNone),
    (Index: 11426; Name: 'ConditionPrint'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11428; Name: 'GetNumQueuedCornerMessages'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11429; Name: 'GetCreatureTurningSpeed'; ParamType1: ptActorBase; ParamType2: ptNone),
    (Index: 11431; Name: 'GetCreatureFootWeight'; ParamType1: ptActorBase; ParamType2: ptNone),
    ...
    (Index: 11459; Name: 'PlayerHasNightVisionActive'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11460; Name: 'PlayerIsDrinkingPlacedWater'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11462; Name: 'IsNight'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11463; Name: 'IsLimbCrippled'; ParamType1: ptInteger; ParamType2: ptInteger),
    (Index: 11464; Name: 'GetNumCrippledLimbs'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 11465; Name: 'GetCrippledLimbsAsBitMask'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 11466; Name: 'GetNumBrokenEquippedItems'; ParamType1: ptFloat; ParamType2: ptInteger),
    (Index: 11467; Name: 'GetEquippedItemsAsBitMask'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11468; Name: 'GetEquippedWeaponType'; ParamType1: ptNone; ParamType2: ptNone),
    ...
    (Index: 11471; Name: 'GetCalculatedMaxCarryWeight'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11482; Name: 'IsReferenceCloned'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11484; Name: 'IsTemporaryReference'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11485; Name: 'GetPCHasScriptedFastTravelOverride'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11486; Name: 'GetPCCanFastTravel'; ParamType1: ptNone; ParamType2: ptNone),
    ...
    (Index: 11493; Name: 'GetCalculatedSkillPoints'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 11496; Name: 'GetCalculatedPerkPoints'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 11509; Name: 'GetActorValueDamage'; ParamType1: ptActorValue; ParamType2: ptNone),
    (Index: 11524; Name: 'GetItemCanHaveHealth'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11557; Name: 'GetCalculatedItemValue'; ParamType1: ptInteger; ParamType2: ptInventoryObject),
    (Index: 11580; Name: 'GetIsPlayerOverencumbered'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 11604; Name: 'GetIsActivationPromptShown'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11605; Name: 'GetHitLocationLingering'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11611; Name: 'GetVATSTargetable'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11615; Name: 'IsPlayerLookingAround'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 11617; Name: 'IsActorInvisibleToPlayer'; ParamType1: ptNone; ParamType2: ptNone)
  );
...
const
  ...
  wbPERKEntryPoints : array[0..73] of TPERKEntryPoint = (
    (Name: 'Calculate Weapon Damage'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate My Critical Hit Chance'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate My Critical Hit Damage'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate Weapon Attack AP Cost'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate Mine Explode Chance'; Condition: epcItem; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Adjust Range Penalty'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Adjust Limb Damage'; Condition: epcAttackerAttackerWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate Weapon Range'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate To Hit Chance'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Adjust Experience Points'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Adjust Gained Skill Points'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Adjust Book Skill Points'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Modify Recovered Health'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate Inventory AP Cost'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Get Disposition'; Condition: epcTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Get Should Attack'; Condition: epcAttacker; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Get Should Assist'; Condition: epcAttackerAttackee; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate Buy Price'; Condition: epcItem; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Get Bad Karma'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Get Good Karma'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Ignore Locked Terminal'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Add Leveled List On Death'; Condition: epcTarget; FunctionType: epfLeveledItem; FunctionTable: epftDefault),
    (Name: 'Get Max Carry Weight'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Modify Addiction Chance'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Modify Addiction Duration'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Modify Positive Chem Duration'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Adjust Drinking Radiation'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Activate'; Condition: epcTarget; FunctionType: epfScript; FunctionTable: epftDefault),
    (Name: 'Mysterious Stranger'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Has Paralyzing Palm'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Hacking Science Bonus'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Ignore Running During Detection'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Ignore Broken Lock'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Has Concentrated Fire'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Calculate Gun Spread'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
    (Name: 'Player Kill AP Reward'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
{36}(Name: 'Modify Enemy Critical Hit Chance'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
{37}(Name: 'Reload Speed'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{38}(Name: 'Equip Speed'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{39}(Name: 'Action Point Regen'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{40}(Name: 'Action Point Cost'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{41}(Name: 'Miss Fortune'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{42}(Name: 'Modify Run Speed'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{43}(Name: 'Modify Attack Speed'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{44}(Name: 'Modify Radiation Consumed'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{45}(Name: 'Has Pip Hacker'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{46}(Name: 'Has Meltdown'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{47}(Name: 'See Enemy Health'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{48}(Name: 'Has Jury Rigging'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{49}(Name: 'Modify Threat Range'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{50}(Name: 'Modify Thread'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{51}(Name: 'Has Fast Travel Always'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{52}(Name: 'Knockdown Chance'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{53}(Name: 'Modify Weapon Strength Req'; Condition: epcWeapon; FunctionType: epfFloat; FunctionTable: epftSubtract),
{54}(Name: 'Modify Aiming Move Speed'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{55}(Name: 'Modify Light Items'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{56}(Name: 'Modify Damage Threshold (defender)'; Condition: epcWeaponTarget; FunctionType: epfFloat; FunctionTable: epftSubtract),
{57}(Name: 'Modify Chance for Ammo Item'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{58}(Name: 'Modify Damage Threshold (attacker)'; Condition: epcWeaponTarget; FunctionType: epfFloat; FunctionTable: epftSubtract),
{59}(Name: 'Modify Throwing Velocity'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{60}(Name: 'Chance for Item on Fire'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{61}(Name: 'Has Unarmed Forward Power Attack'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{62}(Name: 'Has Unarmed Back Power Attack'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
{63}(Name: 'Has Unarmed Crouched Power Attack'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{64}(Name: 'Has Unarmed Counter Attack'; Condition: epcWeaponTarget; FunctionType: epfUnknown; FunctionTable: epftDefault),
{65}(Name: 'Has Unarmed Left Power Attack'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{66}(Name: 'Has Unarmed Right Power Attack'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{67}(Name: 'VATS HelperChance'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{68}(Name: 'Modify Item Damage'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{69}(Name: 'Has Improved Detection'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{70}(Name: 'Has Improved Spotting'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{71}(Name: 'Has Improved Item Detection'; Condition: epcDefault; FunctionType: epfUnknown; FunctionTable: epftDefault),
{72}(Name: 'Adjust Explosion Radius'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault),
{73}(Name: 'Reserved'; Condition: epcWeapon; FunctionType: epfUnknown; FunctionTable: epftDefault)
  );
