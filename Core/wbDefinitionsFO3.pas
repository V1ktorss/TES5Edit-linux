...
const
  wbConditionFunctions : array[0..243] of TConditionFunction = (
    ...
    (Index: 449; Name: 'HasPerk'; ParamType1: ptPerk; ParamType2: ptNone),
    ...
    // Added by FOSE:
    (Index: 1024; Name: 'GetFOSEVersion'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1025; Name: 'GetFOSERevision'; ParamType1: ptNone; ParamType2: ptNone),
    (Index: 1028; Name: 'GetWeight'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1082; Name: 'IsKeyPressed'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 1165; Name: 'GetWeaponHasScope'; ParamType1: ptInventoryObject; ParamType2: ptNone),
    (Index: 1166; Name: 'IsControlPressed'; ParamType1: ptInteger; ParamType2: ptNone),
    (Index: 1213; Name: 'GetFOSEBeta'; ParamType1: ptNone; ParamType2: ptNone)
  );
...
const
  ...
  wbPERKEntryPoints : array[0..36] of TPERKEntryPoint = (
    (Name: 'Calculate Weapon Damage'; Condition: epcWeaponTarget; FunctionType: epfUnknown),
    (Name: 'Calculate My Critical Hit Chance'; Condition: epcWeaponTarget; FunctionType: epfUnknown),
    (Name: 'Calculate My Critical Hit Damage'; Condition: epcWeaponTarget; FunctionType: epfUnknown),
    (Name: 'Calculate Weapon Attack AP Cost'; Condition: epcWeapon; FunctionType: epfUnknown),
    (Name: 'Calculate Mine Explode Chance'; Condition: epcItem; FunctionType: epfUnknown),
    (Name: 'Adjust Range Penalty'; Condition: epcWeapon; FunctionType: epfUnknown),
    (Name: 'Adjust Limb Damage'; Condition: epcAttackerAttackerWeapon; FunctionType: epfUnknown),
    (Name: 'Calculate Weapon Range'; Condition: epcWeapon; FunctionType: epfUnknown),
    (Name: 'Calculate To Hit Chance'; Condition: epcWeaponTarget; FunctionType: epfUnknown),
    (Name: 'Adjust Experience Points'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Adjust Gained Skill Points'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Adjust Book Skill Points'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Modify Recovered Health'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Calculate Inventory AP Cost'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Get Disposition'; Condition: epcTarget; FunctionType: epfUnknown),
    (Name: 'Get Should Attack'; Condition: epcAttacker; FunctionType: epfUnknown),
    (Name: 'Get Should Assist'; Condition: epcAttackerAttackee; FunctionType: epfUnknown),
    (Name: 'Calculate Buy Price'; Condition: epcItem; FunctionType: epfUnknown),
    (Name: 'Get Bad Karma'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Get Good Karma'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Ignore Locked Terminal'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Add Leveled List On Death'; Condition: epcTarget; FunctionType: epfLeveledItem),
    (Name: 'Get Max Carry Weight'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Modify Addiction Chance'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Modify Addiction Duration'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Modify Positive Chem Duration'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Adjust Drinking Radiation'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Activate'; Condition: epcTarget; FunctionType: epfScript),
    (Name: 'Mysterious Stranger'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Has Paralyzing Palm'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Hacking Science Bonus'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Ignore Running During Detection'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Ignore Broken Lock'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Has Concentrated Fire'; Condition: epcDefault; FunctionType: epfUnknown),
    (Name: 'Calculate Gun Spread'; Condition: epcWeapon; FunctionType: epfUnknown),
    (Name: 'Player Kill AP Reward'; Condition: epcWeaponTarget; FunctionType: epfUnknown),
    (Name: 'Modify Enemy Critical Hit Chance'; Condition: epcWeaponTarget; FunctionType: epfUnknown)
  );
...
begin
  if wbBeginInternalEdit then try
    ...
    if lMainRecord.ElementExists['DATA - Visual Data'] then begin
      ...
      lDNAM := lMainRecord.ElementByName['DNAM - Visual Data'] as IwbContainerElementRef;

      lDATA := lMainRecord.ElementByName['DATA - Visual Data'] as IwbContainerElementRef;

      for i := 0 to Pred(lDATA.ElementCount - 1) do begin
